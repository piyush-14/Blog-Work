...
var documents = [{
    ...
    "id": 5,
    "url": "https://piyush-14.github.io/2020/01/28/My-First-Post.html",
    "title": "My First Post",
    "body": "2020/01/28 - If you start youtube, then only for coffee time. Half an hour for brush and coffee. 15 minutes get your thoughts straight. Study for 2 hours. (Fastai/Pytorch Practice. ) Breakfast break 15 mins. (eat something heavy that will last for 3 hours) Study for 2 hours(Coffee if you need ,which you will. )[Blog/Kaggle] 15 minutes to look back for what you have. Have some snacks or lunch depending on your mood. Again study for 2 and a half hours. [HackerRank Practice] (if need something as motivation watch something good) Motivation: Do you like to be mediocre? Now it’s been almost 6 hours. You are exhausted now. Eat something and wander away from screen. Talk to anybody, anything. (that should be about 30 minutes) Now Drink a strong coffee with some dates. Study for 3 hours straight. [Github/Book/Papers Implementation with coding practice] Take a nap. (max 1 hour) You don’t care what is going on outside your screen. Don’t indulge yourself into anything. FOCUS. If you have finished the daily course and still have some strength left check for the next course. If its too long then get a head start. Last Chance. "
    }, {
    "id": 6,
